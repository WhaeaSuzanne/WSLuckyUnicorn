...
v2.1 - now setting up all the statement_decoration prints for the entire game and setting up instructions.
v2.1 make the opening bids for amounts to play. Remove the rounds requirement as no longer needed.
...
def instructions():
    ...
    instructions_statement = "How to Play"
    instructions_decoration = "*"

    print()
    statement_generator(instructions_statement, instructions_decoration)

    print("Choose a starting amount - minimum $1, maximum $10.")
    print("Then press <enter> to play. You will get either a donkey, a horse, a zebra or a unicorn.")
    print("It costs $1 per round. Depending on your prize you may win some money back.")
    statement_generator("Payout Amounts", "$")
    print("Unicorn - $5 (your balance increases by $4)")
    print("Horse - $0.5 (your balance decreases by $0.5)")
    print("Zebra - $0.5 (your balance decreases by $0.5)")
    print("Donkey - $0 (your balance decreases by $1)")
    return ""
...
balance = int(input("How much do you want to play with? Minimum $1, Maximum $10: $"))
print("You have ${:.2f} to play with.".format(balance))
print()

while to_play != "xxx" or to_play == "":
    # game play - see instructions for how this plays out
    ...
    print()
    if balance < 1:
        # break out of loop if balance is at 0
        print("Sorry, you have run out of money")
        to_play = "xxx"

thanks_statement = "Thanks for playing."
thanks_decoration = "&"

statement_generator(thanks_statement, thanks_decoration)
